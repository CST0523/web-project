    ...
    <div class="web" style="width: 100%; height: 100%;">
      ...
      <div class="kajang">
            <a href="mrtKajang.php" style="text-decoration: none;">
                <div class="boxKajangLine" style="background: #8EE2F5;"></div>
        ...
        <div class="putrajaya">
            <a href="mrtPutrajaya.php" style="text-decoration: none;">
                <div class="boxPutrajayaLine" style="background: #5CB9CE;"></div>
                <div class="putrajaya-line">Putrajaya Line</div>
            </a>
        </div>

    <div class="route-map">Route Map</div>
      <img class="KajangLineMap" src="img/mrtKajang.png" />
    </div>
  </body>
</html>